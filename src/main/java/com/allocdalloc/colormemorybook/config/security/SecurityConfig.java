package com.allocdalloc.colormemorybook.config.security;

import com.allocdalloc.colormemorybook.config.jwt.JwtAuthenticationFilter;
import com.allocdalloc.colormemorybook.config.jwt.JwtExceptionFilter;
import com.allocdalloc.colormemorybook.config.jwt.JwtTokenUtil;
import com.allocdalloc.colormemorybook.config.log.LoggingFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        return httpSecurity
                ...
                .antMatchers("/sample", "/api/auth/login", "/api/auth/test/generate-token").permitAll()
