...
public class JwtTokenUtil {
    ...
    // jwt 토큰 생성
    public String generateAccessToken(long userId, Role role, String email, boolean isActive) {
        Date now = new Date();
    ...
    public String generateRefreshToken(long userId, Role role, String email, boolean isActive) {
